...
class TestGetReferencingFksWithInheritance(object):
    ...
    def test_with_self_reference(self, User, Admin, TextItem):
        ...
        assert User.__table__.foreign_keys | TextItem.__table__.foreign_keys == fks

    def test_with_primary_keys(self, User, Admin, TextItem):
        fks = get_referencing_foreign_keys(Admin, self_reference=True, primary_keys=True)
